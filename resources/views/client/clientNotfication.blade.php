...
<div class="email-container" id="notification">
...
<script>
        function refreshStats() {
            $.ajax({
                url: '/client/notification/refresh',
                method: 'GET',
                success: function(response) {
                    $("#notification-refresh").empty().append($(response).find("#notification-refresh").html());
